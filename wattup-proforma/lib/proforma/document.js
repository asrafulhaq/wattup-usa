// @ts-nocheck
/* PORTED VERBATIM from private/tool/js/doc.js. Do not edit the body.
 *
 ...
 *
 * If you need to change behaviour here, change it in private/tool/js/doc.js first, re-run the
 * parity test, and copy the result across. Types live in document.d.ts.
 *
 * The one addition to the body's dependencies: as four script tags these files
 * shared a global scope, and doc.js read DESIGN_DEFAULTS straight out of model.js.
 * As modules that has to be an explicit import. It is the only cross-file symbol;
 * the parity test is what found it. */

import { DESIGN_DEFAULTS } from './model';
...
export { renderDoc, usd, n0, pct, MONTHS };
