        ...
        <FadeUp delay={0.4} yOffset={20} className="w-full flex-col font-sans">
          <div className="flex flex-row items-center justify-center gap-[16px]">
            <WattupButton
              ...
              className="w-full md:w-auto max-md:px-4"
            >
              Our Growing Network
            </WattupButton>
            <WattupButton
              ...
              variant="white"
              className="w-full md:w-auto  max-md:px-4 max-md:shadow-[0px_4px_14px_rgba(0,0,0,0.05)] max-md:border max-md:border-[#E2E8F0]"
            >
              Partner With Us
            </WattupButton>
          </div>
