...
export function SectionIntro({
    heading = 'Building the Infrastructure Behind EV Adoption',
    description = (
        <>
            {' '}
            ...
            <p className='text-[16px] font-normal text-dark/50 md:text-dark/70 leading-[110%] tracking-[-3%]'>
                Focused on execution, capital efficiency, and long-term network
                value.
            </p>
        </>
    ),
    ...
    return (
        <section className='w-full common-section-padding'>
            <div className='container mx-auto'>
                ...
                <div className='flex flex-col md:flex-row md:items-start justify-between max-md:text-center gap-8'>
                    {/* Left — headline (~55% width) */}
                    <FadeUp className='max-w-[644px]'>
                        <h1 className='headline-dark'>{heading}</h1>
                    </FadeUp>
                    ...
                    <FadeUp
                        ...
                        <WattupButton
                            href={ctaLink || '/contact#contact-us'}
                            className='max-md: w-full md:w-[247px]'>
                            {ctaText || 'Request Investor Access'}
                        </WattupButton>
                    </FadeUp>
                </div>
            </div>
