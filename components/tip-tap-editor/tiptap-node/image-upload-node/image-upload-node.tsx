...
import { CloseIcon } from '@/components/tip-tap-editor/tiptap-icons/close-icon';
import '@/components/tip-tap-editor/tiptap-node/image-upload-node/image-upload-node.scss';
