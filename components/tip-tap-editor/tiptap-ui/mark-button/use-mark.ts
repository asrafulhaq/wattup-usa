...
// --- Icons ---
import { BoldIcon } from '@/components/tip-tap-editor/tiptap-icons/bold-icon';
import { Code2Icon } from '@/components/tip-tap-editor/tiptap-icons/code2-icon';
import { ItalicIcon } from '@/components/tip-tap-editor/tiptap-icons/italic-icon';
import { StrikeIcon } from '@/components/tip-tap-editor/tiptap-icons/strike-icon';
import { SubscriptIcon } from '@/components/tip-tap-editor/tiptap-icons/subscript-icon';
import { SuperscriptIcon } from '@/components/tip-tap-editor/tiptap-icons/superscript-icon';
import { UnderlineIcon } from '@/components/tip-tap-editor/tiptap-icons/underline-icon';
