...
// --- Icons ---
import { HeadingFiveIcon } from '@/components/tip-tap-editor/tiptap-icons/heading-five-icon';
import { HeadingFourIcon } from '@/components/tip-tap-editor/tiptap-icons/heading-four-icon';
import { HeadingOneIcon } from '@/components/tip-tap-editor/tiptap-icons/heading-one-icon';
import { HeadingSixIcon } from '@/components/tip-tap-editor/tiptap-icons/heading-six-icon';
import { HeadingThreeIcon } from '@/components/tip-tap-editor/tiptap-icons/heading-three-icon';
import { HeadingTwoIcon } from '@/components/tip-tap-editor/tiptap-icons/heading-two-icon';
