...
export function ArticlesDataTable({ initialData, initialTotalCount }: ArticlesDataTableProps) {
    ...
    useEffect(() => {
        ...
        if (pagination.pageIndex === 0 && pagination.pageSize === 10 && data === initialData) {
            return;
        }

        const fetchData = async () => {
            setIsLoading(true);
            const result = await getPaginatedArticles(pagination.pageIndex + 1, pagination.pageSize);
