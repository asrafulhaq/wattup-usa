    ...
    const handleSave = async () => {
        ...
        try {
            const res = await updateSiteSettings({
                ...
                googleSiteVerification: siteVerification || null,
                metaPixelId: pixelId || null,
                headScripts: headScripts || null,
                bodyStartScripts: bodyStartScripts || null,
                bodyEndScripts: bodyEndScripts || null,
                ...
                orgTwitter: orgTwitter || null,
                orgLinkedin: orgLinkedin || null,
                orgFacebook: orgFacebook || null,
                orgInstagram: orgInstagram || null,
            });
