...
export const FAQGrouped = () => {
  ...
  const [openStates, setOpenStates] = useState<{ [key: string]: number[] }>(
    GroupedFAQData.reduce((acc, cat) => ({ ...acc, [cat.category]: [] }), {}),
  );
        ...
        <div className="flex flex-col flex-1 w-full shrink-0 md:w-[670px]">
          <FadeUp className="w-full">
            ...
            <p className="text-description text-dark md:text-dark/70 mb-10 md:mb-[82px] font-normal! mt-4">
              If you don’t find the answer to your question here, just write to
              us.
            </p>
          </FadeUp>
            ...
            {filteredData.map((categoryGroup) => {
              ...
              return (
                <div
                  ...
                  id={categoryGroup.category.replace(/\s+/g, "-").toLowerCase()}
                ...
                >
                  ...
                  <div className="flex flex-col border-t border-dark/20">
                    {categoryGroup.items.map((item, itemIndex) => {
                      const isOpen =
                        openStates[categoryGroup.category].includes(itemIndex);
                      return (
                        <div
                          key={itemIndex}
                          className={cn(
                        ...
                        >
                          <button
                            onClick={() =>
                              toggleFaqProper(categoryGroup.category, itemIndex)
                            }
